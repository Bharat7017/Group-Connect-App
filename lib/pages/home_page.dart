// ignore_for_file: prefer_const_constructors, use_build_context_synchronously, await_only_futures, unused_field, prefer_final_fields, sort_child_properties_last, unused_local_variable
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "Ooops! You have not joined any groups, But don't Worry -> tap on the add icon to create group or also search from top search button.",
            textAlign: TextAlign.center,
          )
        ],
      ),
